document.addEventListener('DOMContentLoaded', function() {
  var searchInput = document.getElementById('search-input91');
  var searchResults = document.getElementById('search-results91');
  ...
  function createBarChart(departements, nombreNaissances) {
    ...
    var ctx = document.getElementById('barChart91').getContext('2d');
  ...
  async function fetchData() {
    try {
      const response = await fetch('Donnees/naissances-2004-91.json');
