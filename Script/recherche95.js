document.addEventListener('DOMContentLoaded', function() {
  var searchInput = document.getElementById('search-input95');
  var searchResults = document.getElementById('search-results95');
  ...
  function createBarChart(departements, nombreNaissances) {
    ...
    var ctx = document.getElementById('barChart95').getContext('2d');
  ...
  async function fetchData() {
    try {
      const response = await fetch('Donnees/naissances-2004-95.json');
