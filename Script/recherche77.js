document.addEventListener('DOMContentLoaded', function() {
  var searchInput = document.getElementById('search-input77');
  var searchResults = document.getElementById('search-results77');
  ...
  function createBarChart(departements, nombreNaissances) {
    ...
    var ctx = document.getElementById('barChart77').getContext('2d');
  ...
  async function fetchData() {
    try {
      const response = await fetch('Donnees/naissances-2004-77.json');
