document.addEventListener('DOMContentLoaded', function() {
  var searchInput = document.getElementById('search-input75');
  var searchResults = document.getElementById('search-results75');
  ...
  function createBarChart(departements, nombreNaissances) {
    ...
    var ctx = document.getElementById('barChart75').getContext('2d');
  ...
  async function fetchData() {
    try {
      const response = await fetch('Donnees/naissances-2004-75.json');
